...
private struct CustomTemplate: Identifiable, Hashable {
    let id: String
...
private struct TemplateFileType: Identifiable, Hashable {
    let id: String
    let title: String
    let pathExtension: String
}

private enum TemplateMoveDirection {
    case up
    case down
}
...
private struct CustomTemplatesCard: View {
    @EnvironmentObject private var model: QuickDocSettingsModel
...
private struct CustomTemplateRow: View {
    @EnvironmentObject private var model: QuickDocSettingsModel
    let rank: Int
