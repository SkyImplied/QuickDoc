<div align="center">
  ...
  <p>
    <a href="https://github.com/SkyImplied/QuickDoc/releases/tag/v1.5.6"><img src="https://img.shields.io/badge/version-v1.5.6-blue" alt="バージョン v1.5.6"></a>
    <img src="https://img.shields.io/badge/platform-macOS%2013%2B-lightgrey?logo=apple" alt="プラットフォーム macOS 13+">
    <img src="https://img.shields.io/badge/built%20with-Swift-F05138?logo=swift&logoColor=white" alt="Swift で開発">
    <a href="https://github.com/SkyImplied/QuickDoc/releases/download/v1.5.6/QuickDoc-1.5.6.dmg"><img src="https://img.shields.io/badge/download-DMG-brightgreen?logo=apple&logoColor=white" alt="DMG をダウンロード"></a>
...
- Finder のトップレベルコンテキストメニューに、任意で有効化できる「快捷操作」サブメニューを追加しました。
- Finder のコンテキストメニューからファイルやフォルダをコピー、ペースト、カットできます。
- 一般設定とメニューバーの「その他の機能」から快捷操作を有効または無効にできます。

### コピー、ペースト、カット

<p align="center">
  <img src="./photos/支持拷贝粘贴和剪切.png" alt="QuickDoc Finder 快捷操作" width="520">
</p>

### 快捷操作の設定

![QuickDoc 快捷操作の設定](./photos/快捷操作界面.png)
...
<p align="center">
  <img src="./photos/菜单栏界面.png" alt="QuickDoc v1.4.0 メニューバーショートカット" width="520">
</p>
...
![QuickDoc の一般設定](./photos/通用设置界面.png)
...
組み込みのファイル形式を有効または無効にし、カスタム拡張子を追加して、プレビュー領域からメニューの順序を編集できます。

![QuickDoc の新規ファイル形式](./photos/新建文件类型界面.png)

### カスタムファイルテンプレート

ファイル形式ごとにテンプレートを管理し、Finder に表示するテンプレートと表示順を調整できます。

![QuickDoc カスタムファイルテンプレート](./photos/自定义文件模版.png)

### テンプレートサブメニュー

表示中のテンプレートは、対応するファイル形式の第 3 階層メニューに表示されます。
