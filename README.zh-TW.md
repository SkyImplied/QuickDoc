<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/SkyImplied/QuickDoc/releases/download/v1.5.6/QuickDoc-1.5.6.dmg"><img src="https://img.shields.io/badge/download-DMG-brightgreen?logo=apple&logoColor=white" alt="下載 DMG"></a>
...
- Finder 頂層右鍵選單新增可選的「快捷操作」子選單。
- 支援直接從 Finder 右鍵選單拷貝、貼上和剪下檔案或資料夾。
- 一般設定與選單列「其他功能」新增快捷操作開關，可隨時啟用或停用。
...
![QuickDoc 快捷操作設定](./photos/快捷操作界面.png)
...
依檔案類型分別管理範本，控制哪些範本顯示在 Finder 右鍵選單中，並調整顯示順序。

![QuickDoc 自訂檔案範本](./photos/自定义文件模版.png)

### 範本第三層選單

顯示中的範本會出現在對應檔案類型的第三層選單中。
