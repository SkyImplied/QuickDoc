<div align="center">
  ...
  <p>
    <a href="https://github.com/SkyImplied/QuickDoc/releases/tag/v1.6.4"><img src="https://img.shields.io/badge/version-v1.6.4-blue" alt="Version v1.6.4"></a>
    ...
    <a href="https://github.com/SkyImplied/QuickDoc/releases/download/v1.6.4/QuickDoc-1.6.4.dmg"><img src="https://img.shields.io/badge/download-DMG-brightgreen?logo=apple&logoColor=white" alt="Download DMG"></a>
...
- Quick Actions now support a customizable expanded or collapsed layout.
- In expanded mode, `Copy`, `Paste`, and `Cut` appear directly in Finder's top-level context menu.
- In collapsed mode, the behavior matches earlier versions: the three actions stay grouped inside the top-level `快捷操作` submenu.

## What's New in v1.6.3

- Fixed the display mode option hit area in General settings so clicking anywhere in an option card switches the mode.
...
If enabled in settings, `在终端中打开` and `复制当前路径` will appear in the top-level Finder context menu. Quick Actions can either stay collapsed under `快捷操作` or expand into top-level `拷贝`, `粘贴`, and `剪切` items.
