<div align="center">
  ...
  <p>
    <a href="https://github.com/SkyImplied/QuickDoc/releases/tag/v1.5.6"><img src="https://img.shields.io/badge/version-v1.5.6-blue" alt="版本 v1.5.6"></a>
    ...
    <a href="https://github.com/SkyImplied/QuickDoc/releases/download/v1.5.6/QuickDoc-1.5.6.dmg"><img src="https://img.shields.io/badge/download-DMG-brightgreen?logo=apple&logoColor=white" alt="下载 DMG"></a>
...
- Finder 右键一级菜单新增可选的“快捷操作”二级菜单。
- 支持直接在 Finder 右键菜单中拷贝、粘贴和剪切文件或文件夹。
- 通用设置与菜单栏“其他功能”中新增快捷操作开关，可随时开启或关闭。
...
![QuickDoc 快捷操作设置](./photos/快捷操作界面.png)
...
<p align="center">
  <img src="./photos/菜单栏界面.png" alt="QuickDoc v1.4.0 菜单栏快捷配置" width="520">
</p>
...
按文件类型分别管理模板，控制哪些模板显示在 Finder 右键菜单中，并调整它们的显示顺序。

![QuickDoc 自定义文件模板](./photos/自定义文件模版.png)

### 模板三级菜单

显示中的模板会出现在对应文件类型的三级菜单里。
